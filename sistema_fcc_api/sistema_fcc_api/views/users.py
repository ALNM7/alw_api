...
class AdminsViewEdit(generics.CreateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        #como cada usuario vienen dos objetos el primero es el objeto admin
        #y el de abajo es de la tabla users que es la que tiene su first and last name
        admin.save()
        temp = admin.user
        temp.first_name = request.data["first_name"]
        temp.last_name = request.data["last_name"]
        temp.save()
        #lo serializa porque devuelve un objeto json 
    ...
    def delete(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({"details":"Algo pasó al eliminar Admin"},400)